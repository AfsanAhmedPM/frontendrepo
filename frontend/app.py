...
st.markdown("""
    ...
    /* Landing Page Styles */
    .landing-title { font-size: 3em; font-weight: 700; color: #fff; text-align: center; margin-bottom: 0px;}
    .landing-subtitle { font-size: 1.5em; color: #aaa; text-align: center; margin-bottom: 30px; }
...
def show_landing_page():
    ...
    st.markdown('<div class="landing-subtitle">Never miss job, interview, or placement emails.</div>', unsafe_allow_html=True)
