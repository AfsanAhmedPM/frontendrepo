...
# --- CONFIGURATION ---
# ✅ CAUTION: I used the hyphenated URL from our previous working step.
# If your Render app is named differently, update this line.
...
with st.sidebar:
    ...
    with col1:
        # ✅ FIX: Use link_button for clean redirection (No Meta Refresh)
        ...
        with tab:
            ...
            for mail in email_list:
                ...
                with st.expander(header_text):
                    ...
                    # ✅ ACTIONS: Trash + Open Gmail
                    c1, c2 = st.columns([1, 4])
                    with c1:
                        # Trash Button with Authentication
                        if st.button("🗑️ Trash", key=f"trash_{msg_id}"):
